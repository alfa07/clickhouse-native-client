...
async fn test_mixed_ddl_and_select() {
    ...
    client
        .query("CREATE TABLE IF NOT EXISTS test_mixed_ops (id UInt64) ENGINE = Memory")
        .await
        .expect("Failed to create table");
...
async fn test_query_returning_empty_result() {
    ...
    client
        .query("CREATE TABLE IF NOT EXISTS test_empty_result (id UInt64) ENGINE = Memory")
        .await
        .expect("Failed to create table");
...
async fn test_query_with_where_no_matches() {
    ...
    client
        .query("CREATE TABLE IF NOT EXISTS test_no_matches (id UInt64) ENGINE = Memory")
        .await
        .expect("Failed to create table");
...
async fn test_string_with_newlines() {
    ...
    client
        .query("CREATE TABLE IF NOT EXISTS test_newlines (text String) ENGINE = Memory")
        .await
        .expect("Failed to create table");
...
async fn test_string_with_unicode() {
    ...
    client
        .query("CREATE TABLE IF NOT EXISTS test_unicode (text String) ENGINE = Memory")
        .await
        .expect("Failed to create table");
