...
async fn test_decimal128() {
    ...
    client
        .query("CREATE TABLE IF NOT EXISTS test_decimal128 (val Decimal128(20)) ENGINE = Memory")
        .await
...
async fn test_ipv4_column() {
    ...
    client
        .query("INSERT INTO test_ipv4 VALUES ('127.0.0.1'), ('192.168.1.1'), ('8.8.8.8')")
        .await
        .expect("INSERT failed");
...
async fn test_ipv6_column() {
    ...
    client
        .query("INSERT INTO test_ipv6 VALUES ('::1'), ('2001:db8::1'), ('fe80::1')")
        .await
        .expect("INSERT failed");
...
async fn test_int128_column() {
    ...
    client
        .query("CREATE TABLE IF NOT EXISTS test_int128 (val Int128) ENGINE = Memory")
        .await
        .expect("Failed to create table");
...
async fn test_uint128_column() {
    ...
    client
        .query("CREATE TABLE IF NOT EXISTS test_uint128 (val UInt128) ENGINE = Memory")
        .await
        .expect("Failed to create table");
